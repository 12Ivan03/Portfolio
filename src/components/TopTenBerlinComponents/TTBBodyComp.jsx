                    ...
                    <div className="nav_UX_Process">
                        ...
                        <div className="btn_procces_nav">
                            <div className="flex_procces_nav">
                                <button className="secondary_btn mesur mesur_TTB"><a href="#research">1. Defining Problems & Opportunities</a></button>
                                <button className="secondary_btn mesur mesur_TTB"><a href="#ideation">2. Research</a></button>
                                <button className="secondary_btn mesur mesur_TTB"><a href="#Design">3. Information Architecture & Layout</a></button>
                            </div>
                            <div className="flex_procces_nav flex_sec_clm_TTB">
                                <button className="secondary_btn mesur mesur_TTB"><a href="#Design">4. Testing</a></button>
                                <button className="secondary_btn mesur mesur_TTB"><a href="#prototyping">5. User Interface</a></button>
                            </div>
                        </div>
                    </div>
                </div>
